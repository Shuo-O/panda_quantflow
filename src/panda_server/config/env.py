...
KAFKA_ENABLE_TRADE_SIGNAL = os.getenv("KAFKA_ENABLE_TRADE_SIGNAL", "false")
KAFKA_TRADE_SIGNAL_TOPIC_PREFIX = os.getenv("KAFKA_TRADE_SIGNAL_TOPIC_PREFIX", "trade.signal")
KAFKA_TRADE_SIGNAL_GROUP_PREFIX = os.getenv("KAFKA_TRADE_SIGNAL_GROUP_PREFIX", "trade-signal-consumer")
...
# ClickHouse 配置
CLICKHOUSE_ENABLE = os.getenv("CLICKHOUSE_ENABLE", "false")
CLICKHOUSE_HOST = os.getenv("CLICKHOUSE_HOST", "localhost")
CLICKHOUSE_HTTP_PORT = int(os.getenv("CLICKHOUSE_HTTP_PORT", "8123"))
CLICKHOUSE_DATABASE = os.getenv("CLICKHOUSE_DATABASE", "default")
CLICKHOUSE_USERNAME = os.getenv("CLICKHOUSE_USERNAME", "")
CLICKHOUSE_PASSWORD = os.getenv("CLICKHOUSE_PASSWORD", "")
CLICKHOUSE_TICK_TABLE = os.getenv("CLICKHOUSE_TICK_TABLE", "future_ticks")
CLICKHOUSE_TIMEOUT = float(os.getenv("CLICKHOUSE_TIMEOUT", "2.0"))
